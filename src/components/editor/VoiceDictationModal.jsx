        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Button onClick={handleInsert} className="bg-cyan-700 text-primary-foreground px-4 py-2 text-sm font-medium rounded-md inline-flex items-center justify-center whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-10 gap-2 hover:bg-purple-700">
                  Insert into Editor
                </Button>
              </div>
            </div>
  ...
  {recordingState === 'recording' &&
      ...
      Stop Recording
          ...
          <p className="text-xs text-center text-slate-500">
            90 seconds maximum. Audio is processed by Whisper and not stored permanently
          </p>
        </div>
      </DialogContent>
    </Dialog>);
