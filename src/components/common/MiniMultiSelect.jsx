            ...
            <CommandGroup className="bg-white px-1">
              {(options || []).map((option) => (
                <CommandItem
                  ...
                  className={
                    itemVariant === "pill"
                      ? "my-1 px-3 py-2 rounded-lg border bg-emerald-50/60 border-emerald-200 text-slate-900 hover:bg-emerald-100 data-[highlighted]:bg-emerald-100 whitespace-normal"
                      : "text-slate-900 hover:bg-slate-100 focus:bg-slate-100 data-[highlighted]:bg-slate-100 data-[selected]:bg-slate-100 data-[selected]:text-slate-900 whitespace-normal"
                  }
