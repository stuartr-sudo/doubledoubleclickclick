...
function HomepageEditorPageInner() {
  ...
  const [formData, setFormData] = useState<HomepageContent>({
    ...
    faq_items: [
      { id: '1', question: 'How does your consulting process work?', answer: 'Our consulting process begins with a comprehensive analysis of your current LLM visibility. We assess how Ai systems understand and rank your brand, then create a customized strategy to improve your positioning. Throughout the process, we provide ongoing guidance and optimization to ensure long-term success.' },
      { id: '2', question: 'What industries do you specialize in?', answer: 'We work with brands across various industries, from technology and SaaS to e-commerce, healthcare, finance, and professional services. Our approach is tailored to each industry\'s unique challenges and opportunities in Ai-powered search.' },
      { id: '3', question: 'How long does it take to see results?', answer: 'Results can vary depending on your current visibility and the scope of optimization needed. Typically, you\'ll start seeing improvements in LLM rankings within 4-8 weeks, with more significant gains appearing over 3-6 months as Ai systems index and understand your optimized content.' },
      { id: '4', question: 'Do you offer one-time consultations?', answer: 'Yes, we offer both one-time consultations and ongoing partnerships. A one-time consultation provides you with a strategic roadmap and actionable recommendations, while ongoing partnerships include continuous optimization, monitoring, and support.' },
      { id: '5', question: 'Can small businesses afford your services?', answer: 'Absolutely. We offer flexible pricing options designed to accommodate businesses of all sizes. Our services are structured to provide value at every level, from startups to enterprise organizations. Contact us to discuss a solution that fits your budget.' },
      { id: '6', question: 'How do I get started?', answer: 'Getting started is simple. Take our 12-step quiz to see where you\'re missing out on LLM visibility, or reach out directly through our contact form. We\'ll schedule a consultation to discuss your goals and create a customized plan for your brand.' },
      { id: '7', question: 'Is this just traditional SEO with Ai added on?', answer: 'No. Traditional SEO focuses on keyword rankings and search engine algorithms. Our approach is specifically designed for how Ai systems (like ChatGPT, Claude, and Gemini) discover, understand, and recommend brands. This requires different strategies around content coherence, brand signals, and how information is structured for Ai consumption.' },
      { id: '8', question: 'How is this different from using ChatGPT or other Ai tools to create content?', answer: 'Using Ai tools to create content is just one piece of the puzzle. Our work focuses on how Ai systems evaluate and recommend brands - which involves site architecture, brand consistency, evidence-based authority, and how all these signals work together. Creating content with Ai doesn\'t guarantee that Ai systems will recommend your brand.' },
      { id: '9', question: 'Do you guarantee Ai rankings or recommendations?', answer: 'We don\'t guarantee specific rankings or recommendations, as Ai systems are constantly evolving. However, we do guarantee a systematic approach based on how Ai systems actually work. Our focus is on building durable visibility through coherence and consistency, which is what Ai systems look for when making recommendations.' }
    ],
    faq_bg_color: '#ffffff',
      ...
      if (res.ok) {
        ...
        setFormData(prev => ({
          ...
          faq_items: Array.isArray(data.faq_items) && data.faq_items.length > 0 
            ? data.faq_items 
            : (prev.faq_items && prev.faq_items.length > 0 ? prev.faq_items : [
                { id: '1', question: 'How does your consulting process work?', answer: 'Our consulting process begins with a comprehensive analysis of your current LLM visibility. We assess how Ai systems understand and rank your brand, then create a customized strategy to improve your positioning. Throughout the process, we provide ongoing guidance and optimization to ensure long-term success.' },
                { id: '2', question: 'What industries do you specialize in?', answer: 'We work with brands across various industries, from technology and SaaS to e-commerce, healthcare, finance, and professional services. Our approach is tailored to each industry\'s unique challenges and opportunities in Ai-powered search.' },
                { id: '3', question: 'How long does it take to see results?', answer: 'Results can vary depending on your current visibility and the scope of optimization needed. Typically, you\'ll start seeing improvements in LLM rankings within 4-8 weeks, with more significant gains appearing over 3-6 months as Ai systems index and understand your optimized content.' },
                { id: '4', question: 'Do you offer one-time consultations?', answer: 'Yes, we offer both one-time consultations and ongoing partnerships. A one-time consultation provides you with a strategic roadmap and actionable recommendations, while ongoing partnerships include continuous optimization, monitoring, and support.' },
                ...
                { id: '8', question: 'How is this different from using ChatGPT or other Ai tools to create content?', answer: 'Using Ai tools to create content is just one piece of the puzzle. Our work focuses on how Ai systems evaluate and recommend brands - which involves site architecture, brand consistency, evidence-based authority, and how all these signals work together. Creating content with Ai doesn\'t guarantee that Ai systems will recommend your brand.' },
                { id: '9', question: 'Do you guarantee Ai rankings or recommendations?', answer: 'We don\'t guarantee specific rankings or recommendations, as Ai systems are constantly evolving. However, we do guarantee a systematic approach based on how Ai systems actually work. Our focus is on building durable visibility through coherence and consistency, which is what Ai systems look for when making recommendations.' }
              ]), // Use defaults if database has no FAQs or empty array
