...
export default function AgenciesPage() {
  ...
  useEffect(() => {
    if (step > 1) {
      trackWizardStep('agencies', step, totalSteps)
    }
  }, [step])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackFormSubmission('agencies', res.ok)
    } catch (error) {
      console.error('Failed to submit lead capture:', error)
      trackFormSubmission('agencies', false)
    } finally {
        ...
        <div className="tier-page-container tier-page-hero-grid">
          ...
          <div className="tier-page-hero-form tier-contact-form">
            ...
            <p className="tier-contact-description">
              Share a few details and we&apos;ll follow up with pricing and a plan for rolling this out across your clients.
            </p>
